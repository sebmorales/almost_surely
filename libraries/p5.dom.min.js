!function(t, e) {
    ...
    function e(e) {
        ...
        i = document.getElementById(e) || document) : e instanceof t.Element ? i = e.elt : e instanceof HTMLElement && (i = e),
        i
    }
    function i(e) {
        ...
        return "VIDEO" === e.tagName || "AUDIO" === e.tagName ? new t.MediaElement(e) : "SELECT" === e.tagName ? createSelect(new t.Element(e)) : new t.Element(e)
    }
    function n(e, i, n) {
        (i._userNode ? i._userNode : document.body).appendChild(e);
        var o = n ? new t.MediaElement(e) : new t.Element(e);
        return i._elements.push(o),
        o
    }
    function o(t, e, i, o) {
        ...
        if (void 0 !== o) {
            var a = function() {
                o(),
                s.removeEventListener("canplaythrough", a)
            };
    ...
    t.prototype.select = function(t, n) {
        ...
        o = (o = s.getElementsByClassName(t)).length ? o[0] : null) : "#" === t[0] ? (t = t.slice(1),
        o = s.getElementById(t)) : o = (o = s.getElementsByTagName(t)).length ? o[0] : null,
        o ? i(o) : null
    }
    ,
    t.prototype.selectAll = function(t, n) {
        var o, s = [], r = e(n);
        if ("." === t[0] ? (t = t.slice(1),
        o = r.getElementsByClassName(t)) : o = r.getElementsByTagName(t),
        o)
    ...
    ["div", "p", "span"].forEach(function(e) {
        ...
        t.prototype[i] = function(t) {
            ...
            return i.innerHTML = void 0 === typeof t ? "" : t,
            n(i, this)
        }
    }),
    t.prototype.createImg = function() {
        var t, e = document.createElement("img"), i = arguments, o = function() {
            t.width = e.offsetWidth || e.width,
            t.height = e.offsetHeight || e.height,
            i.length > 1 && "function" == typeof i[1] ? (t.fn = i[1],
            t.fn()) : i.length > 1 && "function" == typeof i[2] && (t.fn = i[2],
            t.fn())
        };
        return e.src = i[0],
        i.length > 1 && "string" == typeof i[1] && (e.alt = i[1]),
        e.onload = function() {
            o()
        }
        ,
    ...
    t.prototype.createSlider = function(t, e, i, o) {
        ...
        s.min = t,
        s.max = e,
        0 === o ? s.step = 1e-18 : o && (s.step = o),
        "number" == typeof i && (s.value = i),
        n(s, this)
    }
    ,
    ...
    t.prototype.createSelect = function() {
        ...
        return "object" == typeof i && "SELECT" === i.elt.nodeName ? (e = i,
        t = this.elt = i.elt) : (t = document.createElement("select"),
        i && "boolean" == typeof i && t.setAttribute("multiple", "true"),
        e = n(t, this)),
        e.option = function(e, i) {
            var n = document.createElement("option");
            n.innerHTML = e,
            arguments.length > 1 ? n.value = i : n.value = e,
            t.appendChild(n)
        }
        ,
        e.selected = function(t) {
            ...
            if (arguments.length > 0) {
                for (n = 0; n < this.elt.length; n++)
                    t.toString() === this.elt[n].value && (this.elt.selectedIndex = n);
                return this
            }
            if (i) {
                for (var n = 0; n < this.elt.selectedOptions.length; n++)
                    e.push(this.elt.selectedOptions[n].value);
                return e
            }
    ...
    t.prototype.createRadio = function() {
        ...
        return a.option = function(t, i) {
            ...
            if (n.type = "radio",
            n.innerHTML = t,
            arguments.length > 1 ? n.value = i : n.value = t,
            ...
            t) {
                ...
                n.setAttribute("id", "defaultradio" + e + "-" + h),
                o.htmlFor = "defaultradio" + e + "-" + h,
    ...
    ,
    t.prototype.createInput = function(t, e) {
        var i = document.createElement("input");
        return i.type = e || "text",
        t && (i.value = t),
        n(i, this)
    }
    ,
    t.prototype.createFileInput = function(e, i) {
        function o(i) {
            for (var n = i.target.files, o = 0; o < n.length; o++) {
                var s = n[o]
                  , r = new FileReader;
                r.onload = function(i) {
                    var n = new t.File(i);
                ...
                s.type.indexOf("text") > -1 ? r.readAsText(s) : r.readAsDataURL(s)
            }
        }
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = document.createElement("input");
            return s.type = "file",
            i && (s.multiple = "multiple"),
            s.addEventListener("change", o, !1),
            n(s, this)
        }
    ...
    t.prototype.createCapture = function() {
        for (var e, i, o = !0, s = !0, r = 0; r < arguments.length; r++)
            arguments[r] === t.prototype.VIDEO ? s = !1 : arguments[r] === t.prototype.AUDIO ? o = !1 : "object" == typeof arguments[r] ? e = arguments[r] : "function" == typeof arguments[r] && (i = arguments[r]);
        ...
        var a = n(l, this, !0);
        return a.loadedmetadata = !1,
        l.addEventListener("loadedmetadata", function() {
            l.play(),
            l.width ? (a.width = l.videoWidth = l.width,
            a.height = l.videoHeight = l.height) : (a.width = a.elt.width = l.videoWidth,
    ...
    t.Element.prototype.child = function(e) {
        return void 0 === e ? this.elt.childNodes : ("string" == typeof e ? ("#" === e[0] && (e = e.substring(1)),
    ...
    t.Element.prototype.center = function(t) {
        ...
        var s = Math.abs(this.parent().offsetWidth - this.elt.offsetWidth)
          ...
          , l = o.y
          , a = o.x;
        return "both" === t || void 0 === t ? this.position(s / 2, r / 2) : "horizontal" === t ? this.position(s / 2, l) : "vertical" === t && this.position(a, r / 2),
    ...
    t.Element.prototype.html = function() {
        return 0 === arguments.length ? this.elt.innerHTML : arguments[1] ? (this.elt.innerHTML += arguments[0],
        this) : (this.elt.innerHTML = arguments[0],
        this)
    }
    ,
    ...
    t.Element.prototype._translate = function() {
        this.elt.style.position = "absolute";
        var t = "";
        return this.elt.style.transform && (t = (t = this.elt.style.transform.replace(/translate3d\(.*\)/g, "")).replace(/translate[X-Z]?\(.*\)/g, "")),
    ...
    t.Element.prototype._rotate = function() {
        var t = "";
        return this.elt.style.transform && (t = (t = this.elt.style.transform.replace(/rotate3d\(.*\)/g, "")).replace(/rotate[X-Z]?\(.*\)/g, "")),
    ...
    t.Element.prototype.style = function(e, i) {
        var n = this;
        if (i instanceof t.Color && (i = "rgba(" + i.levels[0] + "," + i.levels[1] + "," + i.levels[2] + "," + i.levels[3] / 255 + ")"),
        void 0 === i) {
            if (-1 === e.indexOf(":"))
                return window.getComputedStyle(n.elt).getPropertyValue(e);
            for (var o = e.split(";"), s = 0; s < o.length; s++) {
                var r = o[s].split(":");
                r[0] && r[1] && (this.elt.style[r[0].trim()] = r[1].trim())
            }
        } else if ("rotate" === e || "translate" === e || "position" === e) {
            var l = Array.prototype.shift.apply(arguments);
            (this[l] || this["_" + l]).apply(this, arguments)
        } else if (this.elt.style[e] = i,
    ...
    t.Element.prototype.attribute = function(t, e) {
        return void 0 === e ? this.elt.getAttribute(t) : (this.elt.setAttribute(t, e),
        this)
    }
    ,
    t.Element.prototype.removeAttribute = function(t) {
        return this.elt.removeAttribute(t),
        this
    }
    ,
    ...
    t.Element.prototype.size = function(e, i) {
        ...
        var n = e
          ...
          , s = t.prototype.AUTO;
        if (n !== s || o !== s) {
            if (n === s ? n = i * this.width / this.height : o === s && (o = e * this.height / this.width),
            this.elt instanceof HTMLCanvasElement) {
                ...
                this.elt.setAttribute("height", o * this._pInst._pixelDensity),
                this.elt.setAttribute("style", "width:" + n + "px; height:" + o + "px"),
                this._pInst.scale(this._pInst._pixelDensity, this._pInst._pixelDensity);
                for (var a in r)
                    this.elt.getContext("2d")[a] = r[a]
            } else
                this.elt.style.width = n + "px",
                this.elt.style.height = o + "px",
                this.elt.width = n,
                this.elt.height = o,
                this.width = n,
                this.height = o;
    ...
    t.MediaElement.prototype.updatePixels = function(e, i, n, o) {
        return this.loadedmetadata && t.Renderer2D.prototype.updatePixels.call(this, e, i, n, o),
        this
    }
    ,
    t.MediaElement.prototype.get = function(e, i, n, o) {
        return this.loadedmetadata ? t.Renderer2D.prototype.get.call(this, e, i, n, o) : void 0 === e ? new t.Image(1,1) : n > 1 ? new t.Image(e,i,n,o) : [0, 0, 0, 255]
    }
    ,
    ...
    t.MediaElement.prototype.connect = function(e) {
        ...
        this.audioSourceNode || (this.audioSourceNode = i.createMediaElementSource(this.elt),
    ...
    t.MediaElement.prototype.removeCue = function(t) {
        for (var e = 0; e < this._cues.length; e++)
            this._cues[e] === t && (console.log(t),
            this._cues.splice(e, 1));
